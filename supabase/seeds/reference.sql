-- Required public reference data captured on 2026-09-16; contains no user data.
-- The baseline embeds this initial dataset; future changes need a new data migration.
