...
BEGIN
  ...
  BEGIN
    ...
    v_exp_points := ROUND(v_exp_points * v_exp_multiplier);
...
COMMENT ON FUNCTION complete_task_all_triggers IS 'Completes a task and handles all operations in separate transactions, increases happiness by 10 (max 100), and avoids ALL trigger conflicts.'; 