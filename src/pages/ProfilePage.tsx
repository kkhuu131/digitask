    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="card mb-6">
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
          ...
          <div 
            className={`w-32 h-32 rounded-full overflow-visible bg-gray-200 flex items-center justify-center relative ${
              user && user.id === profileData?.id ? 'cursor-pointer hover:opacity-80' : ''
            }`}
            onClick={() => {
          ...
          >
            ...
            {user && user.id === profileData?.id && (
              <div className="absolute bottom-0 right-0 bg-primary-600 text-white rounded-full p-1 shadow-md transform translate-x-1 translate-y-1">
          ...
          <div className="flex-1">
            <h1 className="text-2xl font-bold mb-2 text-center md:text-left">
              ...
              {isOwnProfile && (
                <span className="text-sm font-normal text-gray-500 ml-2">(You)</span>
              )}
            </h1>
            
            <div className="text-gray-600 mb-4 text-center md:text-left">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-4">
              <div className="text-center p-2 bg-gray-50 rounded">
                ...
                {/* <div className="text-xs text-gray-500">{discoveredDigimon.length} / 341</div> */}
          ...
          {/* Friend Actions (placeholder for future) */}
          {/* {!isOwnProfile && (
