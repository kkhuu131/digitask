...
const allAttributes: DigimonAttribute[] = [
  'Fire',
  'Water',
  'Plant',
  'Electric',
        ...
        return (
          ...
          >
            ...
            <ManualSection title="What is Digitask?">
              <p className="mb-4">
                Digitask combines task management with virtual pet gameplay to make productivity
                fun!
              </p>
              <p className="mb-4">
                Complete tasks to care for your Digimon, help them evolve, and battle against other
                players.
              </p>
              <p>
                This guide will walk you through all the features and mechanics of Digitask to help
                you get started.
              </p>
            </ManualSection>
            ...
            <ManualSection title="Getting Started">
              <div className="flex flex-col md:flex-row gap-6 items-center mb-6">
                <div className="md:w-1/2">
                  <p className="mb-4">
                    You set your own tasks. You can set 1 active Digimon at a time. Your active
                    Digimon will recieve full experience from completed tasks, and the rest of your
                    Digimon will recieve half experience.
                  </p>
                  <p className="mb-4">
                    Keep your Digimon happy and healthy, earn experience points for your Digimon,
                    complete your daily quota, and build a streak for increased experience points.
                  </p>
        ...
        return (
          ...
          >
            ...
            <ManualSection title="Task Types">
              <p className="mb-4">There are 3 types of tasks: daily, recurring, and regular.</p>
              <div className="flex flex-col md:flex-row gap-6 mb-6">
                ...
                <div className="md:w-1/2">
                  ...
                  <p className="mb-4">
                    One-time tasks have a set date and time and provide slightly more rewards than
            ...
            <ManualSection title="Task Categories & Stat Bonuses">
              <div className="mb-4">
                ...
                These tasks are automatically given a category based on its description, but can be
                changed. When completed, the task will give that stat bonus, either to your active
                Digimon, or saved for later use. These stat bonuses can help you reach stat
                requirements for evolutions.
              </div>
              <div className="mb-4">
                There is also a cap to the amount of stat bonuses a Digimon can have at once,
                explained in the Digimon Care section.
              </div>
            </ManualSection>
            ...
            <ManualSection title="Daily Quota & Streaks">
              <div>
                <p className="mb-4">
                  Each day, you have a daily quota of 3 tasks. Completing your daily quota will
                  reward your whole team with 100 experience points. Continuing to complete your
                  daily quota will build a streak, and will multiplicatively increase the experience
                  points you earn up to 2.5x.
                </p>
                <p className="mb-4">
                  Missing your daily quota or any task will decrease your Digimon's happiness!
                </p>
          ...
          >
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 italic">
                  Nurture your digital companions
                </p>
              </div>
            </div>
            ...
            <ManualSection title="Happiness">
              <p className="mb-4">
                Happiness is a measure of how happy your Digimon is. A lower happiness will decrease
                the subsequent experience points you earn from tasks.
              </p>
            </ManualSection>

            <ManualSection title="Personality">
              <p className="mb-4">
                Each Digimon has a personality that marginally affects stats. Each personality type
                increases its corresponding stat by 5%.
              </p>

              <div className="flex flex-col gap-2 mb-4">
                <p className="mb-2">The personality types are:</p>
                <ul>
                  <li>
                    <b>Durable:</b> HP
                  </li>
            ...
            <ManualSection title="Stats & Growth">
              <p className="mb-4">
                Stats overall will increase as your Digimon levels up and from stat bonuses you
                receive from tasks.
              </p>
            </ManualSection>
            ...
            <ManualSection title="Managing Multiple Digimon">
              <p className="mb-4">
                You will gain the option to nurture multiple Digimon as you progress. You can manage
                multiple Digimon at once. You can set one Digimon as active, and the rest will be
                inactive.
              </p>
            </ManualSection>
          </motion.div>
        ...
        return (
          ...
          >
            ...
            <ManualSection title="Evolution Basics">
              <p className="mb-4">
                Evolution changes your Digimon's form, stats, types, and attributes. Evolutions
                typically require a minimum level, and some stat requirements (ex. 1000 HP).
              </p>
              <p className="mb-4">
                Many Digimon will have multiple branching evolutions, and you will typically not
                know which evolution you will get until after you evolve, unless you've discovered
                it already. You can still see the silhouettes of the evolutions, so you can get an
                idea of what you will get.
              </p>
              <p className="mb-4">
            ...
            <ManualSection title="ABI (Ability)">
              <p className="mb-4">
                In addition to the typical stats, each Digimon has a special stat called ABI or
                Ability. This stat is only earned from evolving, or devolving your Digimon.
              </p>
              <p className="mb-4">
                The amount gained is calculated by the formula:
                <br />
                <br />
                <span className="font-bold">Amount for Digivolution = 1 + (Level / 10)</span>
                <br />
                <span className="font-bold">Amount for De-Digivolution = 1 + (Level / 5)</span>
              </p>
              <p className="mb-4">
                ABI is used for several things, to calculate the cap of stat bonuses you can have,
                for some evolutions, and the milestone rewards (further explained in the Milestones
                section).
              </p>
              <p className="mb-4">
                ...
                <br />
                <br />
                <span className="font-bold">Cap = 50 + (ABI / 2)</span>
              </p>
            </ManualSection>

            <ManualSection title="Evolution Stages">
              <p className="mb-4">
                Each Digimon has a stage, which basically just determines how far along the Digimon
                is in its evolution path.
              </p>
              <p className="mb-4">
                In order, the stages are: Baby, In-Training, Rookie, Champion, and Ultimate, Mega,
                and Ultra. Some special Digimon may have a different stage such as Armor or None.
              </p>
            </ManualSection>

            <ManualSection title="Evolution Requirements">
              <p className="mb-4">
                Evolution requirements are typically a minimum level, and multiple stat
                requirements.
              </p>
              <p className="mb-4">
            ...
            <ManualSection title="De-Digivolution">
              ...
              <p className="mb-4">
                This is a beneficial process, as it gives more ABI than evolving. It also allows you
                to explore other paths that you may have missed.
              </p>
            </ManualSection>

            <ManualSection title="DNA Digivolution">
              <p className="mb-4">
                Lastly, there is a special kind of evolution called DNA Digivolution or Fusion. This
                requires a 2nd Digimon to fuse with the current. This consumes the 2nd Digimon, and
                won't transfer over the 2nd Digimon's bonus stats or ABI.
              </p>
            </ManualSection>
          </motion.div>
        );
        ...
        return (
          ...
          >
            ...
            <ManualSection title="Battle Basics">
              <p className="mb-4">
                Battles are 3v3 turn-based encounters where your Digimon team faces off against
                opponents. Success depends on your Digimon's stats, levels, and strategic use of
                Type and Attribute advantages.
              </p>
            ...
            <ManualSection title="Attribute Advantages">
              <p className="mb-4">
                Attributes add another layer of strategy. Each Attribute is strong against another
                specific Attribute:
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-4 p-3 bg-gray-100 rounded-lg">
                {allAttributes
                  .filter((attr) => attr !== 'Neutral')
                  .map((attribute) => {
              ...
              <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-r">
                <p className="text-sm">
                  <span className="font-bold">Tip:</span> Combining Type and Attribute advantages
                  can result in up to 3x damage!
                </p>
              </div>
            </ManualSection>
            ...
            <ManualSection title="Stats in Battle">
              <p className="mb-4">
                Understanding how stats affect battle performance is crucial for building effective
                teams:
              </p>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="py-2 px-4 border">
                        Determines how much damage your Digimon can take before being defeated
                      </td>
                    </tr>
                    <tr>
                      <td className="py-2 px-4 border font-medium text-orange-700">ATK</td>
                      <td className="py-2 px-4 border">
                        Determines physical attack damage; blocked by opponent's DEF
                      </td>
                    </tr>
                    <tr>
                      <td className="py-2 px-4 border font-medium text-green-700">DEF</td>
                      <td className="py-2 px-4 border">
                        Reduces damage from physical attacks (ATK)
                      </td>
                    </tr>
                    <tr>
                      <td className="py-2 px-4 border font-medium text-purple-700">INT</td>
                      <td className="py-2 px-4 border">
                        Determines special attack damage and reduces special attack damage received
                      </td>
                    </tr>
                    <tr>
              ...
              <ul className="list-disc pl-5 mb-4">
                <li>
                  Digimon automatically use their highest offensive stat (ATK or INT) when attacking
                </li>
            ...
            <ManualSection title="Battle Strategy Tips">
              <ul className="list-disc pl-5 space-y-3">
                <li>
                  <span className="font-medium">Balanced team composition:</span> Try to build up a
                  diverse team, so you can counter different types of opponents.
                </li>
                <li>
                  <span className="font-medium">Stat specialization:</span> Consider specializing
                  some Digimon in ATK and others in INT for versatile offense.
                </li>
                <li>
                  <span className="font-medium">Speed advantage:</span> Faster Digimon attack first,
                  potentially defeating opponents before they can act.
                </li>
                <li>
                  <span className="font-medium">Evolution planning:</span> Some evolutions have
                  better Type/Attribute combinations for battles.
                </li>
                <li>
                  <span className="font-medium">Regular training:</span> Complete tasks consistently
                  to keep your Digimon's happiness and stats high.
                </li>
              </ul>
            </ManualSection>
          </motion.div>
        ...
        return (
          ...
          >
            ...
            <ManualSection title="ABI Milestone">
              <p className="mb-4">
                As your ABI across all your Digimon increases, you will be able to raise more
                Digimon at once:
              </p>
            ...
            <ManualSection title="Claiming">
              ...
              <p className="mb-4">Claiming a Digimon will let you select a baby Digimon.</p>
            </ManualSection>
            ...
            <ManualSection title="Titles">
              <p className="mb-4">
                As you progress, you will be able to unlock titles to display on your profile. There
                are different ways to unlock these:
              </p>
        ...
        return (
          ...
          >
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold text-lg mb-1">
                    What happens if I miss my daily quota?
                  </h4>
                  <p>
                    Missing your daily quota will decrease your Digimon's happiness and reset your
                    streak. This means you'll lose your XP multiplier bonus. Try to complete at
                    least 3 tasks each day to maintain your streak.
                  </p>
                </div>

                <div>
                  <h4 className="font-semibold text-lg mb-1">
                    Can I have multiple active Digimon?
                  </h4>
                  <p>
                    No, only one Digimon can be active at a time. Your active Digimon is the one
                    that receives experience from completed tasks. You can switch your active
                    Digimon at any time from the "Your Digimon" page.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    When your Digimon reaches the required level and meets any specific stat
                    requirements, evolution options will appear on your Digimon's profile. Click the
                    "Evolve" button to choose an evolution path.
                  </p>
                </div>

                <div>
                  <h4 className="font-semibold text-lg mb-1">
                    What's the best way to allocate stat points?
                  </h4>
                  <p>
                    It depends on your goals. For balanced growth, distribute points evenly. For
                    specific evolutions, focus on the stats required for that evolution. For battle
                    specialists, concentrate on either ATK or INT, plus SPD.
                  </p>
                </div>
            ...
            <ManualSection title="Pro Tips">
              <ul className="list-disc pl-5 space-y-3">
                <li>
                  <span className="font-medium">Task Management:</span> Create a mix of daily,
                  recurring, and one-time tasks to maintain a steady flow of rewards.
                </li>
                <li>
                  <span className="font-medium">Stat Allocation:</span> Save some stat points for
                  when you need to meet specific evolution requirements.
                </li>
                <li>
                  <span className="font-medium">Battle Strategy:</span> Build a team with
                  complementary Types and Attributes to counter various opponents.
                </li>
                <li>
                  <span className="font-medium">Evolution Planning:</span> Check the DigiDex to plan
                  your evolution paths in advance.
                </li>
                <li>
                  <span className="font-medium">Happiness Management:</span> Complete at least one
                  task daily to prevent happiness from dropping too low.
                </li>
                <li>
                  <span className="font-medium">Milestone Efficiency:</span> Claim milestone rewards
                  as soon as they're available to start working toward the next one.
                </li>
                <li>
                  <span className="font-medium">Digimon Collection:</span> Rotate your active
                  Digimon to level up multiple team members over time.
                </li>
              </ul>
            </ManualSection>
            ...
            <ManualSection title="Getting Help">
              ...
              <ul className="list-disc pl-5 mb-4 space-y-2">
                <li>
                  <span className="font-medium">This Manual:</span> Refer to the appropriate section
              ...
              <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-r">
                <p className="text-sm">
                  <span className="font-bold">Remember:</span> Digitask is designed to help you be
                  more productive while having fun. Use it in a way that works best for you!
                </p>
              </div>
            </ManualSection>
          </motion.div>
