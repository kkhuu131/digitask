...
const Tournament: React.FC = () => {
  ...
  const roundKey = currentTournament
    ? (String(currentTournament.current_round) as '1' | '2' | '3')
    : null;
            ...
            <div className="bg-white dark:bg-dark-300 rounded-2xl p-8 max-w-sm w-full text-center shadow-2xl">
              {roundResultState.winner === 'user' ? (
                ...
                <>
                  ...
                  <h2 className="text-2xl font-bold text-red-500 dark:text-red-400 mb-1">
                    Defeated
                  </h2>
                  <p className="text-gray-500 dark:text-gray-400 mb-4 text-sm">
                    You reached{' '}
                    {
                      PLACEMENT_LABELS[
                        ['', 'qf_loss', 'sf_loss', 'gf_loss'][roundResultState.round]!
                      ]
                    }
                  </p>
                </>
                ...
                {roundResultState.placementBits > 0 && (
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-amber-600 dark:text-amber-400">
                      +{roundResultState.placementBits} bits
                    </span>
                  </div>
                )}
              </div>
            ...
            <div className="bg-indigo-50 dark:bg-accent-900/20 rounded-2xl border border-indigo-200 dark:border-accent-700 p-6">
              ...
              <div className="grid grid-cols-2 gap-2 mb-5 text-sm">
                {[
                  ...
                  <div
                    key={label}
                    className="flex justify-between bg-white dark:bg-dark-300 rounded-lg px-3 py-2 border border-indigo-100 dark:border-accent-800"
                  >
