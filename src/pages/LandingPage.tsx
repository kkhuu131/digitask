      ...
      <main>
        ...
        <section className="container mx-auto px-4 py-24 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-10 font-body leading-relaxed">
            ...
            evolve, and battle with 400+ Digimon partners.
          </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {features.map((f) => (
                <div key={f.title} className={`rounded-2xl border p-6 ${f.bg}`}>
                  <div
                    className={`w-11 h-11 rounded-xl flex items-center justify-center mb-4 ${f.color} bg-current/10`}
                  >
                    <span className={f.color}>{f.icon}</span>
                  </div>
                  <h3 className={`font-heading text-xl font-bold mb-2 ${f.color}`}>{f.title}</h3>
                  <p className="text-gray-600 dark:text-gray-400 font-body text-sm leading-relaxed">
                    {f.desc}
                  </p>
                </div>
              ))}
              ...
              {steps.map((s) => (
                <div key={s.num} className="flex items-start gap-5">
                  <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-amber-50 border border-amber-200 dark:bg-amber-500/10 dark:border-amber-500/30 flex items-center justify-center">
                    <span className="font-heading text-amber-600 dark:text-amber-400 font-bold text-sm">
                      {s.num}
                    </span>
                  </div>
