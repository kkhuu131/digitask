...
const UserDigimonPage = () => {
  ...
  const [pendingDevolution, setPendingDevolution] = useState<{
    digimonId: string;
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="card dark:bg-dark-300 dark:border-dark-200">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            You can have up to 9 Digimon total. Only one Digimon can be active at a time.
          </p>
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-center my-2">
                        <DigimonSprite
                          ...
                          size="sm"
                          onClick={() => handleShowDetailModal(digimon.id)}
                          enableHopping={evolutionData[digimon.digimon_id]?.some((option) => {
