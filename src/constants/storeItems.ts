...
export const STORE_ITEMS: StoreItem[] = [
  ...
  },
  {
    id: 'x_antibody',
    name: 'X-Antibody',
    description: 'Grants a Digimon the ability to switch to its X-Antibody form at will',
    category: ItemCategory.SPECIAL,
    price: 3000,
    currency: 'bits',
  ...
  // Evolution requirement items
  {
    id: 'digi_egg_of_courage',
    name: 'Digi-Egg of Courage',
    description: 'A Digi-Egg required for certain armor-type evolutions',
    category: ItemCategory.SPECIAL,
    price: 2000,
    currency: 'bits',
    imageUrl: '/assets/items/digiegg.png',
    applyType: ItemApplyType.INVENTORY,
    effect: {
      type: 'evolution_item',
      value: 1,
  ...
  {
    id: 'human_spirit_of_flame',
    name: 'Human Spirit of Flame',
    description: 'A powerful spirit required for certain human-type evolutions',
    category: ItemCategory.SPECIAL,
    price: 2000,
    currency: 'bits',
    imageUrl: '/assets/items/spirit.png',
    applyType: ItemApplyType.INVENTORY,
    effect: {
      type: 'evolution_item',
      value: 1,
  ...
  {
    id: 'beast_spirit_of_flame',
    name: 'Beast Spirit of Flame',
    description: 'A powerful spirit required for certain beast-type evolutions',
    category: ItemCategory.SPECIAL,
    price: 2000,
    currency: 'bits',
    imageUrl: '/assets/items/spirit.png',
...
// create helper function to get the item name from the id
export const getItemName = (id: string) => {
  return STORE_ITEMS.find((item) => item.id === id)?.name;
};
