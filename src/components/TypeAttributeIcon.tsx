...
const TypeAttributeIcon: React.FC<TypeAttributeIconProps> = ({
  ...
  return (
    ...
    >
      ...
      {showTooltip && (
        <div
          className={`absolute ${getTooltipPositionClasses()} left-1/2 transform -translate-x-1/2 shadow-lg rounded-md overflow-hidden opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-50 w-56`}
        >
