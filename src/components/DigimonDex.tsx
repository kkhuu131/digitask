      ...
      {selectedDigimon &&
        (() => {
          ...
          return (
            <>
              {/* Mobile backdrop */}
              <div className="fixed inset-0 bg-black/40 z-30 md:hidden" onClick={closeDetails} />
                ...
                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-dark-200 shrink-0">
                  <div>
                    ...
                    <p className="text-xs font-body text-gray-500 dark:text-gray-400">
                      ...
                      <span
                        className={`font-semibold px-1.5 py-0.5 rounded-full text-xs ${stageColor}`}
                      >
                ...
                <div className="overflow-y-auto flex-1 p-4 space-y-5">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedDigimon.type && (
                      <span
                        className={`font-body text-xs font-semibold px-3 py-1 rounded-full ${typeColor}`}
                      >
                        {selectedDigimon.type}
                      </span>
                    )}
