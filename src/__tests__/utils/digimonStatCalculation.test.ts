...
describe('calculateFinalStats', () => {
  ...
  it('adds hp_bonus * 10 to HP', () => {
    const digimon = {
      ...
      spd_bonus: 0,
      digimon: {
        hp_level1: 100, hp: 500, hp_level99: 1000,
        sp_level1: 50,  sp: 100, sp_level99: 500,
        atk_level1: 10, atk: 50, atk_level99: 100,
        def_level1: 10, def: 50, def_level99: 100,
        int_level1: 10, int: 50, int_level99: 100,
        spd_level1: 10, spd: 50, spd_level99: 100,
      },
    };
  ...
  it('applies Fighter personality 5% ATK bonus', () => {
    const digimon = {
      ...
      digimon: {
        hp_level1: 100, hp: 500, hp_level99: 1000,
        sp_level1: 50,  sp: 100, sp_level99: 500,
        atk_level1: 20, atk: 50, atk_level99: 100,
        def_level1: 10, def: 50, def_level99: 100,
        int_level1: 10, int: 50, int_level99: 100,
        spd_level1: 10, spd: 50, spd_level99: 100,
      },
  ...
  it('does not apply personality bonus to other stats', () => {
    const digimon = {
      ...
      digimon: {
        ...
        sp_level1: 50,  sp: 100, sp_level99: 500,
        atk_level1: 20, atk: 50, atk_level99: 100,
        def_level1: 30, def: 50, def_level99: 100,
        int_level1: 30, int: 50, int_level99: 100,
        spd_level1: 30, spd: 50, spd_level99: 100,
      },
    };
    const result = calculateFinalStats(digimon);
